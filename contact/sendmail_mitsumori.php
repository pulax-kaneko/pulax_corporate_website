...
// このファイルの名前
$script ="sendmail_mitsumori.php";

// メールを送信するアドレス(複数指定する場合は「,」で区切る)
$to = "info@pulax.co.jp";

// 送信されるメールのタイトル
$sbj = "【ホームページからのお見積もり依頼】";
...
$next = "http://www.pulax.co.jp/contact/mitsumoriform.html";
...
$resbj = "お見積もりのご依頼ありがとうございました【株式会社プラックス】";

// 必須入力項目を設定する(する=1, しない=0)
$esse = 1;

// 必須入力項目(入力フォームで指定したname)
$eles = array('貴社名','ご担当者名','ご担当者フリガナ','TEL','email');
...
$body="以下の内容でホームページからのお見積もり依頼がありました。\n";
$body.="ご対応願います。\n\n";
...
<script type="text/javascript">
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-8107852-1']);
